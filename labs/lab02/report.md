...
subtitle: "Задача о погоне - вариант 67"
...
![траектории для случая 1 (Julia)](image/01lj.png){ #fig:002 width=70% height=70% }
...
![траектории для случая 2 (Julia)](image/02lj.png){ #fig:004 width=70% height=70% }
