...
subtitle: "Модель боевых действий - вариант 67"
...
В начальный момент времени страна $X$ имеет армию численностью 44200 человек, а в распоряжении страны $Y$ армия численностью в 54100 человек.
...
$$
 \begin{cases}
	\frac{dx}{dt}= -0.312x(t) - 0.456y(t) + sin(3+1)
	\\   
	\frac{dy}{dt}= -0.256x(t) - 0.34y(t) + cos(7+t)
 \end{cases}
$$
