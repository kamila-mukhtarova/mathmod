...
subtitle: "Модель хищник-жертва - вариант 67"
...
$$
 \begin{cases}
	\frac{dx}{dt} = -0.81x(t) + 0.048y(t)x(t)
	\\   
	\frac{dy}{dt} = 0.76y(t) - 0.038y(t)x(t)
 \end{cases}
$$

Постройте график зависимости численности хищников от численности жертв, а также графики изменения численности хищников и численности жертв 
при следующих начальных условиях: $x_0=7, y_0=29$
...
Стационарное состояние $x_0=\frac{a}{b}=16.875, y_0=\frac{c}{d}=20$
